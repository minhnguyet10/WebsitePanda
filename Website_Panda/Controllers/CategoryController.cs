...
namespace Website_Panda.Controllers
{
    public class CategoryController : ManagementController
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,CategoryName,Note")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,CategoryName,Note")] Category category)
        {
            if (ModelState.IsValid)
            {
